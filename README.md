...
<div style="text-align: center;">
    <img src="img\different_range.png" alt="Evaluation results of different SV size regions style="display: inline-block; margin-right: 20px;" width="500"/>
</div>
...
The SV reference region size statistics before filtering for user-called set (Sniffles): Total SVs number：116615

The SV reference region size statistics after filtering for user-called set (Sniffles): Total SVs number：116427
